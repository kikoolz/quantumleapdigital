    ...
    <section className="container mx-auto px-4 py-16 md:py-24 bg-white/2 rounded-3xl my-16">
      ...
      >
        ...
        <p className="text-white/60 max-w-2xl mx-auto">
          We follow a structured approach to ensure the best results for your
          business.
        </p>
      </motion.div>
        ...
        {steps.map((step, index) => (
          ...
          >
            <div className="flex flex-col md:flex-row items-start mb-12 md:mb-16 relative">
              <div className="shrink-0 w-12 h-12 rounded-full bg-linear-to-br from-indigo-500/30 to-rose-500/30 flex items-center justify-center z-10">
                <span className="text-xl font-bold">{index + 1}</span>
              </div>

              {index < steps.length - 1 && (
                <div className="absolute left-6 top-12 w-px h-[calc(100%+64px)] bg-linear-to-b from-indigo-500/20 to-rose-500/20 transform -translate-x-1/2 md:block hidden" />
              )}
