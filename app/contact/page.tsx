    ...
    <main>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h2 className="text-3xl font-bold mb-6 bg-clip-text text-transparent bg-linear-to-r from-indigo-300 via-white/90 to-rose-300">
              Get in Touch
            </h2>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                <div className="w-10 h-10 rounded-full bg-white/3 border border-white/8 flex items-center justify-center mr-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/60">+971-523972152</p>
                </div>
              </div>
          ...
          <div className="bg-white/2 border border-white/8 rounded-2xl p-6 md:p-8">
            <ContactForm />
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="w-full h-[400px] rounded-2xl overflow-hidden relative">
          <div className="absolute inset-0 bg-linear-to-t from-[#030303] via-transparent z-10 pointer-events-none" />
          <iframe
